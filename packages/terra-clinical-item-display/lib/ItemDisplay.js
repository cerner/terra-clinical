...
var ItemDisplay = function ItemDisplay(_ref) {
  ...
  var displayClassNames = (0, _classnames2.default)(['terraClinical-ItemDisplay', customProps.className]);

  var textClassNames = (0, _classnames2.default)(['terraClinical-ItemDisplay-text', { 'terraClinical-ItemDisplay-text--isTruncated': isTruncated }, _defineProperty({}, 'terraClinical-ItemDisplay-text--' + textStyle, textStyle)]);
