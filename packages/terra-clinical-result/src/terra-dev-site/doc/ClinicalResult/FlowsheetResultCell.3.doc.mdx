...
Note: The Flowsheet Result Cell has a minimum width requirement of 10em (10 times the font-size provided to it) to prevent a blood pressure value from being truncated, provided the unit of measure is hidden and not displayed. For normal Terra theme usage, this will typically be 140px (assuming for base font-size at 14px).
