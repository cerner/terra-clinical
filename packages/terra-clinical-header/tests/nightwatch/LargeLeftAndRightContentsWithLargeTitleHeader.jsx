...
const startContent = <div id="headerTest--startContent" style={{ backgroundColor: 'black', height: '100px', width: '2000px', margin: '0 10px 0 0' }} />;
const endContent = <div id="headerTest--endContent" style={{ backgroundColor: 'black', height: '100px', width: '2000px', margin: '0 0 0 10px' }} />;
