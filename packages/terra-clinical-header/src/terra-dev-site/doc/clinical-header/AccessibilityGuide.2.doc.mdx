...
import Whitespace from '/packages/terra-clinical-header/lib/terra-dev-site/doc/layout-helpers/WhiteSpace.js';
import WebAIMSemanticHeadingContentStructure from '/packages/terra-clinical-header/lib/terra-dev-site/doc/reference/WebAIMSemanticHeadingContentStructure';
