...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large', 'huge', 'enormous'], {
  'Displays a clinical item view with default props': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-view/default-item-view`);
    browser.expect.element('#ItemView').to.be.present;
  },

  'Displays a clinical item view with displays present': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-view/displays-item-view`);
  ...
  'Displays a clinical item view with a start accessory': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-view/accessory-item-view`);
  ...
  'Displays a clinical item view with a comment set': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-view/comment-item-view`);
  ...
  'Displays a clinical item view with the word wrap and truncation': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-view/overflow-displays-item-view`);
