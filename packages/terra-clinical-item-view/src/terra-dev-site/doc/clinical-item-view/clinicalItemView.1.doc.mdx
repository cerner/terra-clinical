...
[View component source code](https://github.com/cerner/terra-clinical/tree/master/packages/terra-clinical-item-view)

## Examples
<ItemViewStandard title="ItemView - Default" />
<ItemViewTwoColumn title="ItemView - Two Column Layout" description="When including icons as part of an '<ItemView.Display />'', it is recommended to use the iconAlignment='inline' prop for best alignment and wrapping with the text." />
