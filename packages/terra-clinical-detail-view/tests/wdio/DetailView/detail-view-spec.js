...
describe('Detail View', () => {
  describe('Displays a divided Detail View with provided components', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      selector,
      properties: {
        '--terra-clinical-detail-view-v2-subtitle-color': 'purple',
        '--terra-clinical-detail-view-v2-accessory-color': 'red',
        '--terra-clinical-detail-view-v2-divider-border-color': 'yellow',
        '--terra-clinical-detail-view-v2-footer-text-color': 'green',
      },
    });
  });
