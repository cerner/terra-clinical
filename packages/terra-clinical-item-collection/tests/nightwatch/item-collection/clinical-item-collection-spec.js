...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large', 'huge', 'enormous'], {
  'Displays a item collection with all possibe elements': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-all-elements`)
  ...
  'Displays a selectable item collection': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-selectable`)
      .expect.element('#ItemCollection').to.be.present;
  },
  ...
  'Displays an item collection with table styles': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-table-styles`)
      .expect.element('#TableStyles').to.be.present;
  },

  'Displays an item collection with list styles': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-list-styles`)
      .expect.element('#ListStyles').to.be.present;
  },

  'Displays an item collection with styles applied to list items': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-item-styles`)
      .expect.element('#ItemStyles').to.be.present;
  },

  'Displays an item collection with items with varying content': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/clinical-item-collection/item-collection-varying-items`)
