...
const examples = () => (
  <div>
    ...
    <LabelValueView label="Collected By" textValue="Noah Brown" isChildOfDescriptionList={false} topicTextId="collectedByTopic" />
    ...
    <LabelValueView label="Temperature" textValue="97 F" topicTextId="temperatureTopic" />
