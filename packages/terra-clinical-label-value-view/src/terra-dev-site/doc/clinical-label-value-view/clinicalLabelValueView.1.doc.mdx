...
The LabelValueView component should be used to create a visual and programmatic association of a label and value pair. An HTML description list is used to create the programmatic structure of the label (a term) to a value (a definition). This semantic structure is critical to support users of assistive technology. 
