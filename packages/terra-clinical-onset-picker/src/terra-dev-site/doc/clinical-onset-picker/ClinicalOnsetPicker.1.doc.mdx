...
![IMPORTANT](https://badgen.net/badge/UX/Accessibility/blue) All inputs must have a visible label that communicates the purpose of the field face up. Ensuring this label is always visible will ensure all users, especially those using assistive technologies, can understand the purpose of the input and interact with the field.
