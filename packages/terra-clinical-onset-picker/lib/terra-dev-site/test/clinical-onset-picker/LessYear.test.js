...
var LessYear = function (_React$Component) {
  _inherits(LessYear, _React$Component);

  function LessYear(props) {
    _classCallCheck(this, LessYear);

    // Lock date to September 20, 2016
    var _this = _possibleConstructorReturn(this, (LessYear.__proto__ || Object.getPrototypeOf(LessYear)).call(this, props));
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Onset picker with minimum required fields and onChange handlers, supplied with a birthdate of 11 months old.'
        ),
        _react2.default.createElement(
          'p',
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_OnsetPicker2.default, {
            birthdate: (0, _moment2.default)().subtract(11, 'months').format(),
