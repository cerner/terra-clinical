...
class BuildYourOwnAlertExample extends React.Component {
  ...
  render() {
    ...
    const actionPropStr = this.state.showActionButton ? 'action={<Button text="Action" size="medium" variant="primary" onClick={this.actionFunc} />}' : '';
      ...
      <div>
        <div>
          <div dir="ltr">
            ...
            <br />
            <code>
              &lt;Alert {alertTypePropStr} {alertTitlePropStr} {alertOnDismissPropStr} {actionPropStr} {customIconPropStr} {customStatusColorPropStr} &gt;
              <br />
              &nbsp;&nbsp;{alertContentPropStr}
              <br />
              &lt;/Alert&gt;
                ...
                <tr>
                  ...
                  <td>
                    <select id="typeSelector" name="type" value={this.state.type} onChange={this.handleTypeSelectChange}>
                      ...
                      <option value={Alert.Opts.Types.GAP_CHECKING}>Alert.Opts.Types.GAP_CHECKING</option>
                      <option value={Alert.Opts.Types.OUTSIDE_RECORDS}>Alert.Opts.Types.OUTSIDE_RECORDS</option>
