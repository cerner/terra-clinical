...
class DataGrid extends React.Component {
  ...
  resizeSectionHeaders(width) {
     ...
     */
    const sectionHeaderContainers = this.dataGridContainerRef.querySelectorAll('[data-terra-clinical-data-grid-section-header-container="true"]');
    ...
    return (
      shouldRenderSectionHeaderContainer ? (
        <div
          ...
          data-terra-clinical-data-grid-section-header-container={isPinned ? true : null}
        >
          { isPinned ? (
            <SectionHeader
