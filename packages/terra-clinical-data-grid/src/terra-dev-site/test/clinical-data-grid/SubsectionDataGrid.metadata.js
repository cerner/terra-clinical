...
export default {
  ...
  steps: [
    {
      name: 'with subsection selections',
      action: () => {
        global.browser.click('#subsection-data-grid [class*="SectionHeader"]');
      },
    },
    {
      name: 'with subsection selection hover',
      themeableProperties: {
        '--terra-clinical-data-grid-section-header-hover-background-color': 'green',
      },
      action: () => {
        global.browser.moveToObject('[data-accessibility-id="0"]');
      },
    },
  ],
};
