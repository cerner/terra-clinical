...
// Component Examples
import TerraClinicalActionHeaderIndex from './packages/terra-clinical-action-header/examples/Index.site-page';
import TerraClinicalSiteIndex from './packages/terra-clinical-site/src/examples/application/Index';
    ...
    pages: [
      {
        name: 'Index',
        path: '/index',
        component: TerraClinicalActionHeaderIndex,
      },
    ],
    tests: [
      {
